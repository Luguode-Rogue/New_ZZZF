...
namespace New_ZZZF
{
    ...
    public class SPSkillItemVM : SPItemVM
    {
        ...
        public SPSkillItemVM(InventoryLogic inventoryLogic, bool isHeroFemale, bool canCharacterUseItem, InventoryScreenHelper.InventoryMode usageType, ItemRosterElement newItem, InventoryLogic.InventorySide inventorySide, int itemCost = 0, EquipmentIndex? itemType = EquipmentIndex.None)
            {
                if (newItem.EquipmentElement.Item == null)
                {
                    return;
                }
                this._fiveStackShortcutKeyText = "";
                this._entireStackShortcutKeyText = "";
