...
namespace New_ZZZF.Skills
{
    internal class LingHunDanMu : SkillBase
    {
        ...
        public override bool Activate(Agent casterAgent)
        {
            ...
            int proficiency = 0;
            if(casterAgent.GetPrimaryWieldedItemIndex()==EquipmentIndex.None) { return false; }
            MissionWeapon mainHandWeapon = casterAgent.Equipment[casterAgent.GetPrimaryWieldedItemIndex()];
        ...
        public static void LingHunDanMuDamage(GameEntity missileEntity)
        {
            ...
            { 
                ...
                if (agentSkill != null) 
                { agentSkill.UpdateCooldowns(2f,SPSkillType.MainActive); }
            }
        }
    }
}
