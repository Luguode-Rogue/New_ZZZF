...
namespace New_ZZZF
{
    internal class DaDiJianTa : SkillBase
    {
        ...
        public bool DaDiJianTaUse(Agent casterAgent)
        {
            ...
            {                       
                ...
                vimAgent.SetActionChannel(0, ActionIndexCache.Create("act_horse_command_follow"), false, (AnimFlags)272UL, 0, 0.1f, -0.2f, 0.4f, 0.0f);
                vimAgent.SetActionChannel(1, ActionIndexCache.Create("act_horse_command_follow"), false, (AnimFlags)272UL, 0, 0.1f, -0.2f, 0.4f, 0.0f);
    ...
    public class DaDiJianTaBuffToEnemy : AgentBuff
    {
        ...
        public override void OnRemove(Agent agent)
        {
            ...
            agent.SetActionChannel(0, ActionIndexCache.Create("act_none"), false, (AnimFlags)272UL, 0, 5f, -0.2f, 0.4f, 1.0f);
            agent.SetActionChannel(1, ActionIndexCache.Create("act_none"), false, (AnimFlags)272UL, 0, 5f, -0.2f, 0.4f, 1.0f);
        }
    }
