...
namespace New_ZZZF
{
    ...
    public class WOW_SandboxStrikeMagnitudeModel : SandboxStrikeMagnitudeModel
    {
        ...
        public override float CalculateStrikeMagnitudeForSwing(in AttackInformation attackInformation, in AttackCollisionData collisionData, in MissionWeapon weapon, float swingSpeed, float impactPointAsPercent, float extraLinearSpeed)
        {
            ...
            float num = CombatStatCalculator.CalculateStrikeMagnitudeForSwing(swingSpeed, currentUsageItem.SweetSpotReach, item.Weight, currentUsageItem.GetRealWeaponLength(), currentUsageItem.TotalInertia, currentUsageItem.CenterOfMass, explainedNumber.ResultNumber);
    ...
    public class WOW_SandboxAgentApplyDamageModel : SandboxAgentApplyDamageModel
    {
        ...
        public override bool DecideCrushedThrough(Agent attackerAgent, Agent defenderAgent, float totalAttackEnergy, Agent.UsageDirection attackDirection, StrikeType strikeType, WeaponComponentData defendItem, bool isPassiveUsage)
        {
            ...
            /*获取攻击方武器数据*/
            EquipmentIndex attackerAgentwieldedOffHandItemIndex = attackerAgent.GetOffhandWieldedItemIndex();
            EquipmentIndex attackerAgentwieldedMainHandItemIndex = attackerAgent.GetPrimaryWieldedItemIndex();
            ...
            //获取防御方武器数据
            EquipmentIndex defenderAgentwieldedItemIndex = attackerAgent.GetPrimaryWieldedItemIndex();
        ...
        public new float CalculateDamage(in AttackInformation attackInformation, in AttackCollisionData collisionData, float baseDamage)
        {
            ...
            Random random = new Random();
            float baseDam = base.CalculateDamage(attackInformation, collisionData, baseDamage);
